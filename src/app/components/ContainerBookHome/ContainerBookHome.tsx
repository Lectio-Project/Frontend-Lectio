...
const ContainerBookHome = ({
    books,
    isTablet,
    isDesktop,
    sort
}: ContainerBookHomeProps) => {
        ...
        <section className="external-home-container-books">
                    ...
                    >
                        <section className="default-book-list-home">
                            ...
                            <section className="info-book-home">
                                ...
                                {book.AuthorBook && book.AuthorBook[0] && (
                                    <span className="book-author-home">
                                        {book.AuthorBook[0].author.name}
                                    </span>
                                )}
                                <div className="container-book-rating-home">
                                    <Rating
                                        className="book-rating-star-home"
                                        max={1}
                                        value={1}
                                        size="large"
                                        readOnly
                                    />
                                    <span className="book-rating-home">
                                        {book.avgGrade.toLocaleString('pt-BR', {
            ...
            {isDesktop && (
                <>
                    <div
                        ref={nextEl}
                        className="swiper-button-next swiper-button-next-books"
                    ></div>
                    <div
                        ref={prevEl}
                        className="swiper-button-prev swiper-button-prev-books"
                    ></div>
                </>
            )}
        </section>
